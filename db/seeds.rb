...
flashcard10 = Flashcard.create(question:"Garlic Bread",answer:"Carbs, but make it fashion", deck_id:2)
flashcard11 = Flashcard.create(question:"Butter",answer:"Put it on everything", deck_id:2)
flashcard12 = Flashcard.create(question:"Mayo",answer:"A condiment", deck_id:2)
